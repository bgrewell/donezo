...
func TestArchivedSpaceWriteGuard(t *testing.T) {
	...
	writes := []struct {
		...
		{http.MethodPatch, "/api/spaces/sandbox/notes/note-1", `{"title":"Nope"}`},
		{http.MethodDelete, "/api/spaces/sandbox/notes/note-1", ""},
...
func TestMutationEndpointsRequireAuth(t *testing.T) {
	...
	endpoints := []struct {
		...
		{http.MethodPost, "/api/spaces/sandbox/notes"},
		{http.MethodPatch, "/api/spaces/sandbox/notes/note-1"},
		{http.MethodDelete, "/api/spaces/sandbox/notes/note-1"},
		{http.MethodPost, "/api/spaces/sandbox/reminders"},
